...
public class RegisterPersonel extends javax.swing.JFrame {
    ...
    private void btn_ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ekleActionPerformed
        ...
        try {
            ...
            st.executeUpdate("INSERT INTO user VALUES(" + fld_ekleid.getText() + ",'" + fld_tcno.getText() + "','" +
                            fld_pass.getText() + "','personel','" + fld_adsoyad.getText() + "');");
            Helper.showMsg("Personel oluşturuldu..");
            dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterPersonel().setVisible(true);
            }
        });
    }
